...
from novena_gateway.connectors.modbus.constants import PymodbusDefaults
from novena_gateway.connectors.modbus.bytes_modbus_downlink_converter import BytesModbusDownlinkConverter
from novena_gateway.connectors.modbus.bytes_modbus_uplink_converter import BytesModbusUplinkConverter
from novena_gateway.connectors.modbus.constants import (
    BAUDRATE_PARAMETER,
...
from novena_gateway.gateway.constants import (
...
if TYPE_CHECKING:
    from novena_gateway.connectors.modbus.modbus_connector import ModbusConnector
    from novena_gateway.connectors.modbus.entities.master import Master
