...
from novena_gateway.connectors.modbus.entities.slave_context import SlaveContext
...
from novena_gateway.gateway.constants import DEVICE_NAME_PARAMETER, TYPE_PARAMETER
