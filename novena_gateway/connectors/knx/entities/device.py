...
from novena_gateway.connectors.knx.knx_uplink_converter import KNXUplinkConverter
from novena_gateway.gateway.constants import CONVERTER_PARAMETER, UPLINK_PREFIX
