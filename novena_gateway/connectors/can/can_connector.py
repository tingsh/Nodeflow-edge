...
from novena_gateway.connectors.can.bytes_can_downlink_converter import BytesCanDownlinkConverter
from novena_gateway.connectors.can.bytes_can_uplink_converter import BytesCanUplinkConverter
