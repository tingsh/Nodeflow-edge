...
log = logging.getLogger("novena_gateway.payload_formatter")


class PayloadFormatter:
    """Transforms ConvertedData from connectors into Novena Hub payloads."""
    ...
    def format(self, converted_data: ConvertedData) -> List[dict]:
        """
        Convert a ConvertedData object into one or more Novena Hub payloads.
