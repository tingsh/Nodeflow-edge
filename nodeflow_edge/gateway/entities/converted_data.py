...
from nodeflow_edge.gateway.constants import ATTRIBUTES_PARAMETER, TELEMETRY_PARAMETER, TIMESERIES_PARAMETER, \
    METADATA_PARAMETER
...
class ConvertedData:
    __slots__ = ['device_name', 'device_type', 'device_id', 'telemetry', 'attributes',
                 'metadata', '_telemetry_datapoints_count', 'ts_index']

    def __init__(self, device_name, device_type='default', metadata=None, device_id=None):
