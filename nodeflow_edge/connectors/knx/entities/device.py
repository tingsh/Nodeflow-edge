...
from nodeflow_edge.connectors.knx.knx_uplink_converter import KNXUplinkConverter
from nodeflow_edge.gateway.constants import CONVERTER_PARAMETER, UPLINK_PREFIX
