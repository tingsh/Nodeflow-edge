...
from nodeflow_edge.connectors.rest.backward_compatibility_adapter import BackwardCompatibilityAdapter
        ...
        if self.__server_config.get('SSL', False):
            if not self.__server_config.get('security'):
                if not os.path.exists('domain_srv.crt'):
                    from nodeflow_edge.connectors.rest.ssl_generator import SSLGenerator
