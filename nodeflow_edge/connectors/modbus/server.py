...
from nodeflow_edge.connectors.modbus.entities.slave_context import SlaveContext
...
from nodeflow_edge.gateway.constants import DEVICE_NAME_PARAMETER, TYPE_PARAMETER
