...
from nodeflow_edge.gateway.constants import SECURITY_VAR, REPORT_STRATEGY_PARAMETER
...
class TBUtility:
    ...
    @staticmethod
    def resolve_different_ts_formats(data: Union[dict, list], config: dict, logger, default_ts: bool = True):
